...
import ExchangeForm from 'app/components/steps/ExchangeForm';
import SenderKYC from 'app/components/steps/SenderKYC';
import PaymentMethod from 'app/components/steps/PaymentMethod';
